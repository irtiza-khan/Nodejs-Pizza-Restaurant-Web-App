...
var cartCounter = document.querySelector('#cartCounter'); //sending data to backend 

var updateCart = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(pizza) {
    var res;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            cartCounter.innerText = res.data.totalQty; //Notify the User 
...
cartBtn.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizzaData = JSON.parse(btn.dataset.pizza); //console.log(pizzaData);
...
Object(_admin_js__WEBPACK_IMPORTED_MODULE_3__["initAdmin"])(); //Change Order Status

var input = document.querySelector('#hiddenInput');
var statuses = document.querySelector('.status_line');
...
__webpack_require__(/*! D:\PROGRAMMING\node js\projects\pizza web app\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\PROGRAMMING\node js\projects\pizza web app\resources\scss\app.scss */"./resources/scss/app.scss");
